        ...
        <div className="pricing-tabs">
          {isMonthly && (
            <button
              ...
              className="pricing-button thq-button-filled thq-button-animated"
            >
          ...
          {!isMonthly && (
            <button
              ...
              className="pricing-button02 thq-button-filled thq-button-animated"
            >
        ...
        {isMonthly && (
          <div className="pricing-container">
            ...
            <div className="pricing-column1 thq-card">
              ...
              <button className="pricing-button05 thq-button-filled thq-button-animated">
            ...
            <div className="pricing-column2 thq-card">
              ...
              <button className="pricing-button06 thq-button-filled thq-button-animated">
        ...
        {!isMonthly && (
          <div className="pricing-container1">
            ...
            <div className="pricing-column4 thq-card">
              ...
              <button className="pricing-button08 thq-button-filled thq-button-animated">
            ...
            <div className="pricing-column5 thq-card">
              ...
              <button className="pricing-button09 thq-button-filled thq-button-animated">
...
Pricing.defaultProps = {
  ...
  plan1Feature1: 'Unlimited complaints',
  plan1Feature2: 'Limited response time',
  ...
  plan1Feature3: 'Community support',
